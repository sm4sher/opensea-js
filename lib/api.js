...
var OpenSeaAPI = /** @class */ (function () {
     ...
     */
    OpenSeaAPI.prototype.postOrder = function (order, retries, opts) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 4]);
                        return [4 /*yield*/, this.post(constants_1.ORDERBOOK_PATH + "/orders/post/", order, opts)];
                    case 1:
                        json = (_a.sent());
                        return [3 /*break*/, 4];
                    case 2:
                    ...
                    case 3:
                        _a.sent();
                        return [2 /*return*/, this.postOrder(order, retries - 1, opts)];
     ...
     * @param retries Number of times to retry if the service is unavailable for any reason
     */
    OpenSeaAPI.prototype.getAsset = function (_a, retries, opts) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 4]);
                        return [4 /*yield*/, this.get(constants_1.API_PATH + "/asset/" + tokenAddress + "/" + (tokenId || 0) + "/", {}, opts)];
                    case 1:
                        json = _b.sent();
                        return [3 /*break*/, 4];
                    case 2:
                    ...
                    case 3:
                        _b.sent();
                        return [2 /*return*/, this.getAsset({ tokenAddress: tokenAddress, tokenId: tokenId }, retries - 1, opts)];
     ...
     */
    OpenSeaAPI.prototype.get = function (apiPath, query, opts) {
        if (query === void 0) { query = {}; }
        if (opts === void 0) { opts = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var qs, url, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        url = apiPath + "?" + qs;
                        return [4 /*yield*/, this._fetch(url, opts)];
                    case 1:
                        response = _a.sent();
