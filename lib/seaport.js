...
var OpenSeaPort = /** @class */ (function () {
     ...
     * @param referrerAddress The optional address that referred the order
     */
    OpenSeaPort.prototype.createBuyOrder = function (_a, opts) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 5:
                        orderWithSignature = __assign(__assign({}, hashedOrder), signature);
                        return [2 /*return*/, this.validateAndPostOrder(orderWithSignature, opts)];
                }
            });
        });
    };
     ...
     */
    OpenSeaPort.prototype.validateAndPostOrder = function (order, opts) {
        if (opts === void 0) { opts = {}; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.api.postOrder(utils_1.orderToJSON(order), 0, opts)];
                    case 2:
    ...
    OpenSeaPort.prototype._makeBuyOrder = function (_a, opts) {
    ...
    OpenSeaPort.prototype._getPriceParameters = function (orderSide, tokenAddress, expirationTime, startAmount, endAmount, waitingForBestCounterOrder, englishAuctionReservePrice) {
        if (waitingForBestCounterOrder === void 0) { waitingForBestCounterOrder = false; }
        return __awaiter(this, void 0, void 0, function () {
            var priceDiff, paymentToken, isEther, basePrice, extra, reservePrice;
            return __generator(this, function (_a) {
                priceDiff = endAmount != null
                    ? startAmount - endAmount
                    : 0;
                paymentToken = tokenAddress.toLowerCase();
                isEther = true // tokenAddress == NULL_ADDRESS
                ;
                ...
                basePrice = utils_1.makeBigNumber(this.web3.toWei(startAmount, 'ether')).round();
                extra = utils_1.makeBigNumber(this.web3.toWei(priceDiff, 'ether')).round();
